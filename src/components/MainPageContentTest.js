...
export class MainPageContentTest extends Component {
    render() {
        return (
            <div>
                <div style={{ width: '100%', height: window.innerHeight - 23, background: "url(https://images.pexels.com/photos/617278/pexels-photo-617278.jpeg)", backgroundSize: '1700px' }}>test</div>
                <ScrollableAnchor id={'sect1'}>
